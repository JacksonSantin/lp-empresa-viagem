  ...
  <section class="container mx-auto px-4 py-16 space-y-16">
    <div class="text-center">
      ...
      <p class="text-lg text-gray-700 leading-relaxed">
        ...
        <b>Netur Viagens e Turismo</b> respeitar a sua privacidade em relação a
        qualquer informação sua que possamos coletar no site
        <a
          href="https://www.netur.com.br/"
          class="text-blue-600 hover:underline"
          >Netur Viagens e Turismo</a
    ...
    <div class="space-y-4">
      ...
      <p class="text-lg text-gray-700 leading-relaxed">
        ...
        informação que o
        <b>Netur Viagens e Turismo</b> oferece no site e com caráter
    ...
    <div class="space-y-4">
      ...
      <p class="text-lg text-gray-700 leading-relaxed">
        Esta política é efetiva a partir de 27 de Dezembro de 2024 - 13:19.
      </p>
    </div>
  </section>
</template>
