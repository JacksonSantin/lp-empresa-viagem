<template>
  <section class="container mx-auto px-4 py-16 space-y-16">
    <div class="text-center mb-8 mt-10">
      <h1 class="text-4xl font-bold mb-4">Viagens Nacionais</h1>
      <p class="text-lg">Descubra destinos incríveis pelo Brasil!</p>
    </div>
...
import { destination } from '~/core/const/destination'
...
const destinos = ref(destination)
