    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
      <div class="flex flex-col justify-center text-justify">
        <p class="text-lg text-gray-600 mb-4">
          A <b>Netur Viagens e Turismo</b> deu início a suas atividades no dia
          15 de abril de 1993, na cidade de Marau, no Rio Grande do Sul, com o
          agenciamento de viagens a negócios e turismo, operando em todo o
          Brasil.
        </p>
        <p class="text-lg text-gray-600 mb-4">
        ...
        <p class="text-lg text-gray-600">
          Toda ação da <b>NETUR</b> tem como finalidade alcançar a satisfação do
          cliente e realizar os sonhos que tem em mente.
          <b>"VOCÊ SONHA A NETUR CONCRETIZA"</b>. A <b>NETUR</b> providencia
